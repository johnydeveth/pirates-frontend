import { Token, PRIMARY_CHAIN_ID } from '@pancakeswap/sdk'
import { PIR_PULSE_LP_MAINNET } from './lp'
import { Ifo } from './types'

export const cakeBnbLpToken = new Token(PRIMARY_CHAIN_ID, PIR_PULSE_LP_MAINNET, 18, 'PIR-PULSE LP')
